...
// ATTENTION!
// You must change `base` and the `proxy` strings replacing `/modules/animated-tile-states/` with your
// module or system ID.
...
export default () => {
  ...
  return {
    ...
    base: '/modules/animated-tile-states/',   // Base module path that 30001 / served dev directory.
    ...
    server: {
      ...
      open: false,
      proxy: {
        '^(/modules/animated-tile-states/languages)': 'http://127.0.0.1:30000',
        '^(?!/modules/animated-tile-states/)': 'http://127.0.0.1:30000',
